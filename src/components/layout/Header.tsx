        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-10 text-sm">
            ...
            <div className="hidden md:flex items-center gap-6 text-muted-foreground">
              ...
              <Link to="/service-area" className="hover:text-primary transition-colors">
                Delivery Areas
              </Link>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex flex-1 max-w-xl mx-8">
            <div className="relative w-full group">
              <input
                type="text"
                placeholder="Search parts by name, brand, or car model..."
                className="w-full h-12 pl-5 pr-12 rounded-lg bg-muted border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
              />
          ...
          <div className="container mx-auto px-4 py-4">
            ...
            <div className="relative mb-4">
              <input
                ...
                className="w-full h-12 pl-5 pr-12 rounded-lg bg-muted border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary"
              />
